...
function MedicinalUse() {
  ...
  return (
    <div>
        ...
        <SideBar/>
        <MenuSlider/>
        <div className='mu_main'  style={{backgroundImage:`url(${teapic2})`}}>
            <div>
        ...
        <div className={`radio_btton_mu ${dish}`}>
          ...
          {dish=="depression"&&(
              ...
              <div>
                  ...
                  <p><span  className='medicinal_highlighter'>Anxiety:</span> Saffron has also been studied for its potential anxiolytic effects. Some research indicates that it may help <br/> reduce symptoms of anxiety, potentially through its impact on serotonin levels and <br/> other neurotransmitter systems.</p>
              </div>
              <div>
                  ...
                  <p><span className='medicinal_highlighter'>Anti-inflammatory Effects:</span> Chronic inflammation is associated with depression, and saffron’s anti-inflammatory<br/> properties might contribute to its mood-enhancing effects.</p>
              </div>
              <div>
                  <h1>dosage and safety</h1>
                  <p><span  className='medicinal_highlighter'>Dosage:</span> Clinical studies have used varying doses of saffron, typically ranging from <span className='numbersfont'>15 to 30</span> mg per day. It's essential to follow recommended dosages and consult a healthcare professional before starting any new supplement.</p>
                  <p><span  className='medicinal_highlighter'>Safety:</span> Saffron is generally considered safe when used in appropriate amounts. However, high doses can be toxic,<br/> and it may interact with certain medications. Consulting a healthcare provider is advisable, especially<br/> for individuals with existing health conditions or those taking other medications.</p>
              </div>
          </div>
          )}
...
<div>
     ...
     <div>
         ...
         <p><span className='medicinal_highlighter'>Mild Cognitive Impairment:</span> Research also suggests that saffron may benefit individuals with mild cognitive impairment,<br/> potentially slowing down cognitive decline and improving overall cognitive performance.</p>
     </div>
     <div>
         <h1>Mechanism of Action</h1>
         ...
         <p><span  className='medicinal_highlighter'>Anti-inflammatory Effects: </span>Chronic inflammation is associated with neurodegenerative diseases, and saffron’s<br/> anti-inflammatory properties may help mitigate this inflammation.</p>
         <p><span  className='medicinal_highlighter'>Neurogenesis:</span> Some studies suggest that saffron may promote neurogenesis <br/>(the growth of new neurons), which can support cognitive <br/> function and memory.</p>
     </div>
     <div>
         <h1>dosage and safety</h1>
         <p><span  className='medicinal_highlighter'>Dosage:</span>  Effective doses used in studies typically range from <span className='numbersfont'>20 to 30</span>mg per day. It's important to adhere to recommended dosages and consult with a healthcare provider for personalized advice.</p>
         <p><span  className='medicinal_highlighter'>Safety:</span> Saffron is generally considered safe when used in moderation. However, high doses can be toxic, and it may<br/> interact with certain medications. Consultation with a healthcare professional is recommended, especially <br/> if you have underlying health conditions or are taking other medications.</p>
     </div>
 </div>
       ...
       {dish == "pain"&&(
         ...
         <div>
             ...
             <p><span className='medicinal_highlighter'>Reduction in Pain Symptoms:</span> Clinical studies have explored saffron’s potential to reduce pain symptoms in <br/>conditions such as osteoarthritis and menstrual pain. For example, research has found that saffron <br/> supplementationcan help reduce pain and improve quality of life in  <br/> individuals with osteoarthritis.</p>
         </div>
         <div>
             <h1>Clinical studies</h1>
             ...
             <p><span className='medicinal_highlighter'>Osteoarthritis:</span> Clinical trials have demonstrated that saffron can help reduce pain and improve joint function in people with osteoarthritis. Studies have shown that saffron supplementation can lead to significant improvements in <br/> pain and disability scores.</p>
         </div>
         <div>
             <h1>dosage and safety</h1>
             <p> <span className='medicinal_highlighter'>Dosage:</span>Effective dosages for anti-inflammatory and pain-relief effects generally range from <span className='numbersfont'>20 to 30</span> mg per day. It’s important to follow recommended dosages and consult with a healthcare provider for personalized advice.</p>
             <p><span className='medicinal_highlighter'>Safety: </span>Saffron is considered safe when used in moderate amounts. However, high doses can be toxic, and it may interact with certain medications. Consulting with a healthcare professional is advisable, especially if you have existing health <br/> conditions or are taking other medications.</p>
         </div>
     </div>
       )}
       ...
       {dish == 'digestive'&&(
         ...
         <div>
             ...
             <p><span className='medicinal_highlighter'>Digestive Health and Appetite Regulation:</span> Saffron may also play a role in appetite regulation and digestive health.<br/> Some studies have explored its potential to reduce appetite and improve satiety, which could be beneficial <br/>for weight management and digestive health.</p>
         </div>
         <div>
             <h1>Mechanism of Action</h1>
             ...
             <p><span className='medicinal_highlighter'>Gastric Motility: </span>There is some evidence that saffron might influence gastric motility <br/>(the movement of food through the digestive tract), which<br/> can affect digestion and overall gastrointestinal function.</p>
         </div>
         <div>
             <h1>dosage and safety</h1>
             <p><span className='medicinal_highlighter'>Dosage:</span> For digestive health, doses typically range from <span className='numbersfont'> 20 to 30 </span>mg per day. It’s important to follow recommended dosages and consult with a healthcare provider for personalized advice.</p>
             <p><span className='medicinal_highlighter'>Safety: </span>Saffron is generally safe when used in moderate amounts. However, high doses can be toxic, and it may interact <br/> with certain medications. Always consult a healthcare professional before starting saffron supplementation, <br/>especially if you have existing digestive conditions or are taking other medications.</p>
         </div>
     </div>
       )}
