    ...
    <div> 
        ...
        <div className='contact_div1' style={{backgroundImage:`url(${contactusback})`}}>
            ...
            <div className={`contact_div121 ${showForm?"true":""}`}>
                    ...
                    <input type="text" placeholder='Name' name='name'  className={`contact-input ${error=="name"?"true":""}`}  value={values.name} onChange={handleChange} />
                    <input type="email" placeholder='Email' name='email'  className={`contact-input ${error=="email"?"true":""}`}   value={values.email} onChange={handleChange} />
                    <textarea name="message" placeholder="Message"  className={`contact-textarea ${error=="message"?"true":""}`}  value={values.message} onChange={handleChange} ></textarea>
                    <button onClick={handleSubmit}>{loading?"SUBMIT":<AiOutlineLoading3Quarters  className='loading-spinnerca'/>}</button>
                    </div>
